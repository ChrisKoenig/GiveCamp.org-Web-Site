...
{
	public class YouTubeFeedWidgetDesigner : ControlDesignerBase
	{
		// embedded resources
		private const string LayoutTemplateReference = "Sitefinity.Widgets.Social.YouTube.YouTubeFeed.YouTubeFeedWidgetDesignerTemplate.ascx";
		private const string DesignerScriptReference = "Sitefinity.Widgets.Social.YouTube.YouTubeFeed.YouTubeFeedWidgetDesigner.js";
