...
namespace Sitefinity.Widgets.Social.Facebook
{
	...
	{
		// embedded resources
		private const string LayoutTemplateReference = "Sitefinity.Widgets.Social.Facebook.LikeBox.LikeBoxWidgetDesignerTemplate.ascx";
		private const string DesignerScriptReference = "Sitefinity.Widgets.Social.Facebook.LikeBox.LikeBoxWidgetDesigner.js";
