...
namespace SitefinityWebApp.Widgets.Social.Vimeo
{
    /// <summary>
    /// Sitefinity widget to show videos from a Vimeo account
    /// </summary>
    [ControlDesigner(typeof(Widgets.Social.Vimeo.VimeoFeedWidgetDesigner)), PropertyEditorTitle("Vimeo Latest Videos")]
