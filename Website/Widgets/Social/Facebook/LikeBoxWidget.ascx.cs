...
namespace SitefinityWebApp.Widgets.Social.Facebook
{
	[ControlDesigner(typeof(Widgets.Social.Facebook.LikeBoxWidgetDesigner)), PropertyEditorTitle("Facebook Like Box")]
	public partial class LikeBoxWidget : System.Web.UI.UserControl
	{
		#region Constants
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			if (WidgetMode == WidgetModeType.FBML) sb.Append(FBML_SCRIPT);
			sb.AppendFormat(WidgetMode == WidgetModeType.IFRAME ? IFRAME_SRC : FBML_SRC, HttpContext.Current.Server.UrlEncode(Url), Width, ColorScheme.ToString().ToLower(), NumConnections, ShowStream, ShowHeader, Height);
